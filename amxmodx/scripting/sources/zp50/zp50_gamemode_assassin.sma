...
public plugin_precache()
{
	...
	register_plugin("[ZP ROTD] Game Mode: Assassin", ZP_VERSION_STRING, "ZP Dev Team + DRON12261")
...
{	
	...
	if (get_pcvar_num(cvar_assassin_show_hud))
	{
		...
		show_dhudmessage(0, "%L", LANG_PLAYER, "NOTICE_ASSASSIN", name)
	}
