...
public plugin_init()
{
	register_plugin("[ZP ROTD] Main Menu", ZP_VERSION_STRING, "ZP Dev Team + DRON12261")
...
{
	zp_colored_print(0, "==== ^x04Zombie Plague: Rise of the Dead %s^x01 ====", ZP_VERSION_STRING)
...
show_menu_main(id)
{
	...
	// Title
	len += formatex(menu[len], charsmax(menu) - len, "\yZombie Plague: Rise of the Dead %s^n^n", ZP_VERSION_STRING)
