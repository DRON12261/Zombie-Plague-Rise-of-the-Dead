...
public plugin_precache()
{
	...
	register_plugin("[ZP ROTD] Game Mode: Nemesis", ZP_VERSION_STRING, "ZP Dev Team + DRON12261")
...
public zp_fw_gamemodes_start()
{
	...
	if (get_pcvar_num(cvar_nemesis_show_hud))
	{
		...
		show_dhudmessage(0, "%L", LANG_PLAYER, "NOTICE_NEMESIS", name)
	}
}
