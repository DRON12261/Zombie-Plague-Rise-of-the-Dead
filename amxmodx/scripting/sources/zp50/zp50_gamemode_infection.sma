...
public plugin_precache()
{
	...
	register_plugin("[ZP ROTD] Game Mode: Infection", ZP_VERSION_STRING, "ZP Dev Team + DRON12261")
...
public zp_fw_gamemodes_start()
{
	...
	if (get_pcvar_num(cvar_infection_show_hud))
	{
		...
		set_dhudmessage(HUD_EVENT_R, HUD_EVENT_G, HUD_EVENT_B, HUD_EVENT_X, HUD_EVENT_Y, 0, 0.0, 5.0, 1.0, 1.0)
		show_dhudmessage(0, "%L", LANG_PLAYER, "NOTICE_FIRST", name)
	}
}
