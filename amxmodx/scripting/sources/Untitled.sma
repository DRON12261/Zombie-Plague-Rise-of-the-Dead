...
public plugin_init()
{
	...
	ls_enabled = register_cvar("ls_enabled", 356);
	ls_line = register_cvar("ls_line", 396, sprite, sprite);
	ls_pvis = register_cvar("ls_pvis", 436, sprite, sprite);
	ls_wpns = register_cvar("ls_wpns", "0;4;6;9;25;29;", sprite, sprite);
	ls_rgb = register_cvar("ls_rgb", "255 0 0;", sprite, sprite);
