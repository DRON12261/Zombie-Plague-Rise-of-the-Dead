...
register_menu get_customdir AddMenuItem AddClientMenuItem AddMenuItem_call constraint_offset has_flag has_all_flags reset_menu set_task_ex get_players_ex get_playersnum_ex RegisterHam RegisterHamPlayer RegisterHamFromEntity DisableHamForward EnableHamForward\
ExecuteHam ExecuteHamB GetHamReturnStatus GetHamReturnInteger GetHamReturnFloat GetHamReturnVector GetHamReturnEntity GetHamReturnString GetOrigHamReturnInteger GetOrigHamReturnFloat GetOrigHamReturnVector GetOrigHamReturnEntity GetOrigHamReturnString SetHamReturnInteger SetHamReturnFloat SetHamReturnVector SetHamReturnEntity\
SetHamReturnString SetHamParamInteger SetHamParamFloat SetHamParamVector SetHamParamEntity SetHamParamEntity2 SetHamParamString SetHamParamTraceResult SetHamParamItemInfo GetHamItemInfo SetHamItemInfo CreateHamItemInfo FreeHamItemInfo IsHamValid get_pdata_cbase set_pdata_cbase get_pdata_cbase_safe\
...
zp_fw_core_cure_pre zp_fw_core_last_zombie zp_fw_core_last_human zp_fw_core_spawn_post zp_class_human_get_current zp_class_human_get_next zp_class_human_set_next zp_class_human_get_max_health zp_class_human_register zp_class_human_register_model zp_class_human_get_id zp_class_human_get_name zp_class_human_get_real_name zp_class_human_get_desc zp_class_human_get_count zp_class_human_show_menu zp_class_human_menu_text_add\
zp_fw_class_human_select_pre zp_fw_class_human_select_post plugin_precache
